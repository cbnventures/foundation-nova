...
<Tabs groupId="install-state">
  ...
  <TabItem value="npx" label="npx (no install)">
    ...
    ```bash
    npx --yes @cbnventures/foundation-nova@latest utility version
    ```
  ...
  <TabItem value="npx" label="npx (no install)">
    <div className="row">
      <div className="col col--6 margin-bottom--sm">
        <CodeBlock language="bash" title="All">
          {`# Original\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest utility version --all`}
          {`\r\n\r\n`}
          {`# Shorthand\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest util ver -a`}
        </CodeBlock>
      </div>
      <div className="col col--6 margin-bottom--sm">
        <CodeBlock language="bash" title="Operating System">
          {`# Original\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest utility version --os`}
          {`\r\n\r\n`}
          {`# Shorthand\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest util ver -o`}
        </CodeBlock>
      </div>
      <div className="col col--6 margin-bottom--sm">
        <CodeBlock language="bash" title="Node.js + Tools">
          {`# Original\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest utility version --node`}
          {`\r\n\r\n`}
          {`# Shorthand\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest util ver -n`}
        </CodeBlock>
      </div>
      <div className="col col--6 margin-bottom--sm">
        <CodeBlock language="bash" title="Web Browsers">
          {`# Original\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest utility version --browser`}
          {`\r\n\r\n`}
          {`# Shorthand\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest util ver -b`}
        </CodeBlock>
      </div>
      <div className="col col--6 margin-bottom--sm">
        <CodeBlock language="bash" title="Interpreters / Runtimes">
          {`# Original\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest utility version --interpreter`}
          {`\r\n\r\n`}
          {`# Shorthand\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest util ver -i`}
        </CodeBlock>
      </div>
      <div className="col col--6 margin-bottom--sm">
        <CodeBlock language="bash" title="Environment Managers">
          {`# Original\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest utility version --env`}
          {`\r\n\r\n`}
          {`# Shorthand\r\n`}
          {`npx --yes @cbnventures/foundation-nova@latest util ver -e`}
        </CodeBlock>
      </div>
    </div>
  </TabItem>
