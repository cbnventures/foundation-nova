...
description: Interactive wizard that loads, edits, and saves the Foundation Nova config file with project details, entities, and canonical URLs straight from the terminal.
keywords:
  - foundation nova
  - nova initialize
  - nova utility init
