...
id: overview
title: Overview
description: Strict, predictable JavaScript and TypeScript toolkit with presets, guided generators, and Airbnb style rules that reduce setup time and deliver consistent, dependable builds.
sidebar_position: 1
keywords:
  - foundation nova
  - javascript toolkit
