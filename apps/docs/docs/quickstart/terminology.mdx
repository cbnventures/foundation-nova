...
id: terminology
title: Terminology
description: Plain language developer terminology that clarifies APIs, packages, JavaScript modules, build tools, Git workflows, testing types, performance terms, and security.
keywords:
